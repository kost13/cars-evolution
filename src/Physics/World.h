...
struct Settings{
    ...
    int sim_max_iter= 36000*10;  //1s = 60 iterations, 60s = 3600 iterations, 10 cars
    int m_velocityIterations=5;  //8
    int m_positionIterations=2;   //3
